...
namespace TaskManager.Domain.Interfaces
{
	public interface ITaskService
	{
		...
		System.Threading.Tasks.Task AddTaskCommentAsync(int taskId, string comment, string commentedBy);
		System.Threading.Tasks.Task<IEnumerable<UserTaskCompletionModel>> GetAverageCompletedTasksPerUserLast30DaysAsync();
	}
}
