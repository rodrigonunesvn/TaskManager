...
namespace TaskManager.Domain.Interfaces
{
	public interface ITaskRepository
	{
		...
		System.Threading.Tasks.Task<IEnumerable<Task>> GetTasksByProjectIdAsync(int projectId);
		System.Threading.Tasks.Task<IEnumerable<Task>> GetTasksByConditionAsync(Expression<Func<Task, bool>> expression);
	}
}
